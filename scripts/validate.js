...
function main() {
  ...
  if (build) {
    // icon = the committed icon.png's public URL. The client registers it with Discord at runtime (authenticated
    // app token) to display it — auto-pulled from this approved list, no manual uploads.
